...
export const RESOURCE_ACTIONS = {
  ...
  patients: {
    create: [ROLES.ADMIN, ROLES.CLINICIAN, ROLES.RECEPTIONIST],
    update: [ROLES.ADMIN, ROLES.CLINICIAN, ROLES.RECEPTIONIST],
    delete: [ROLES.ADMIN, ROLES.CLINICIAN, ROLES.RECEPTIONIST],
